$(function () {
    $("#create-new-report").click(function () {
        console.log("Prompt user to select at dataet for new report...");
...
PowerBIEmbedManager.embedReport = function (reportId, embedUrl, accessToken, reportContainer) {
    ...
    $("#setStateFilter").click(function () {
        var basicStateFilter = {
            ...
            operator: "In",
            values: ["FL", "GA", "NC", "AL", "LA", "TN"]
        };
        report.setFilters([basicStateFilter]);
        // update UI buttons
        $("#setStateFilter").hide();
        $("#removeStateFilter").show();
    });
    $("#removeStateFilter").click(function () {
        report.setFilters([]);
        // update UI buttons
        $("#removeStateFilter").hide();
        $("#setStateFilter").show();
    });
};
